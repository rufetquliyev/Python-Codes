...
Sonra ic-ice Python/General Python deye folderler hazirlayin. 
Ardindan Python Notlar faylini ora elave edin. Daha sonra eyni faylin kopyasini Desktopa atin. 
